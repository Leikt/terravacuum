...
def render_mock(_context: Context, component: MockComponent, indent: int = 0) -> str:
    return f"mock_component[name = {component.name} first_name = {component.first_name}]"


def render_mock_with_expressions(context: Context, component: MockComponent, indent: int = 0) -> str:
